...
m.C.style.position="relative";m.C.style.marginTop="-"+m.CO;m.C.style.top="-"+(m.CO+50);
...
a.C.style.top="-"+(a.CO+50);a.CL.innerHTML="";a.CI.value="";if(a.MgI==a.Mg){a.N.D.removeChild(a.N.D.firstChild);
